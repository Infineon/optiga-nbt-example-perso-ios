...
/// operations related to  *NBT Personalization* application. It conforms to the
/// ``ObservableObject`` to effectively manage UI components  on ``SplashScreenView``. It can be
